...
async function openModal() {
  isOpen.value = true
  const resp = await services.getAccountDetails()
...
<template>
  ...
  >
    ...
    >
      <path
        fill="#FFFFFF"
        d="M16.399,7.643V10.4c0,2.236-1.643,4.629-5.399,4.959V18h2.6c0.22,0,0.4,0.18,0.4,0.4v1.2
              ...
              >
                ...
                >
                  ...
                  <div class="flex items-center justify-center">
                    <div v-for="family in familyId" :key="family" class="inline-flex  shadow-md hover:shadow-lg focus:shadow-lg" role="group">
                      <a
                        href="#"
                        aria-current="page"
